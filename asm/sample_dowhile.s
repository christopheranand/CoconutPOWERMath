...
.set TO_LT,16; .set TO_GT,8; .set TO_EQ,4; .set TO_LLT,2; .set TO_LGT,1
        ...
        .rename H.18.square{TC},"square"
        .rename H.22.constants{TC},"constants"
        .rename H.30.memregion{TC},"memregion"
...
# .text section
        .file   "square.c","Mon Aug  7 15:55:23 2023 ","IBM XL C for AIX, Version 16.1.0.13"



        .csect  H.10.NO_SYMBOL{PR}, 7
.square:                                # 0x00000000 (H.10.NO_SYMBOL)
        stu        SP,-80(SP)
        st         r3,104(SP)   # mrOut
        st         r4,108(SP)   # mrIn
        st         r5,112(SP)   # ptr to size
        # l          r5,0(r5)   # size
        cal        r3,0(r0)
        st         r3,64(SP)
__L18:                                  # 0x00000018 (H.10.NO_SYMBOL+0x18)
        l          r3,108(SP)
        l          r4,64(SP)
        rlinm      r4,r4,3,0,28
        lfdx       fp1,r3,r4
        fa         fp1,fp1,fp1
        l          r3,T.30.memregion(RTOC)
        lfdx       fp2,r3,r4
        fa         fp1,fp1,fp2
        l          r3,104(SP)
        stfdx      fp1,r3,r4
        ...
        l          r4,0(r4)
        cmp        0,r3,r4
        bc         BO_IF,CR0_LT,__L18
        b          __L60
__L60:                                  # 0x00000060 (H.10.NO_SYMBOL+0x60)
        cal        SP,80(SP)
...
T.30.memregion:
        .tc     H.30.memregion{TC},memregion{RW}


        .csect  square{DS}
        .long   .square                 # "\0\0\0\0"
        .long   TOC{TC0}                # "\0\0\001\0"
        .long   0x00000000              # "\0\0\0\0"
# End   csect   square{DS}
        ...
        .long   0x00000000              # "\0\0\0\0"
        .long   0x00000000              # "\0\0\0\0"
        .long   0x3ff00000              # "?\360\0\0"
        .long   0x00000000              # "\0\0\0\0"
        .long   0x40000000              # "@\0\0\0"
        .long   0x00000000              # "\0\0\0\0"
        .long   0x40080000              # "@\b\0\0"
        .long   0x00000000              # "\0\0\0\0"
        .long   0x40100000              # "@\020\0\0"
        .long   0x00000000              # "\0\0\0\0"
        .long   0x40140000              # "@\024\0\0"
        .long   0x00000000              # "\0\0\0\0"
        .long   0x40180000              # "@\030\0\0"
        .long   0x00000000              # "\0\0\0\0"
        .long   0x401c0000              # "@\034\0\0"
        .long   0x00000000              # "\0\0\0\0"
# End   csect   constants{RO}
