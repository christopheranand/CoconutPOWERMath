...
# .text section
        .file   "square.c","Wed Aug  2 21:23:31 2023 ","IBM XL C for AIX, Version 16.1.0.13"
...
.square:                                # 0x00000000 (H.10.NO_SYMBOL)
        ...
        l          r4,0(r4)
        cmp        0,r3,r4
        bc         BO_IF_NOT,CR0_LT,__L60
__L28:                                  # 0x00000028 (H.10.NO_SYMBOL+0x28)
        l          r3,108(SP)
        l          r4,64(SP)
        rlinm      r4,r4,3,0,28
        lfdx       fp1,r3,r4
        ...
        l          r4,0(r4)
        cmp        0,r3,r4
        bc         BO_IF,CR0_LT,__L28
__L60:                                  # 0x00000060 (H.10.NO_SYMBOL+0x60)
        b          __L64
__L64:                                  # 0x00000064 (H.10.NO_SYMBOL+0x64)
        cal        SP,80(SP)
